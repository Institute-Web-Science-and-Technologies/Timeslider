...
import de.unikoblenz.west.lkastler.data.DataModel.TimeFrame;
...
public class TimesliderView extends View implements OnGestureListener,
		OnDoubleTapListener, DataModelListener {
	...
	protected void onDraw(Canvas canvas) {
		...
		long hour = getWidth() / (timeFrames[currentTimeFrameId].getTime() / DataModel.HOUR) ;
